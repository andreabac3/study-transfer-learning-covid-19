...
def function_grad_cam(model, image_path: str, use_cuda: bool = False):
    ...
    cv2.imwrite("andrea_cam.jpg", cam)
    cv2.imwrite("andrea_gb.jpg", gb)
    cv2.imwrite("andrea_cam_gb.jpg", cam_gb)
